 ...
 * GenerateCode()
 */
Result BinaryExpression::GenerateCode()
{
	Result value;

	/*TODO: Implementar BinaryExpression::GenerateCode */

	return value;
}

Result UnaryExpression::GenerateCode()
{
	Result value;

	/*TODO: Implementar UnaryExpression::GenerateCode */

	return value;
}

Result LValueExpression::GenerateCode()
{
	Result value;

	/*TODO: Implementar LValueExpression::GenerateCode */

	return value;
}

Result MethodCallExpression::GenerateCode()
{
	Result value;

	/*TODO: Implementar MethodCallExpression::GenerateCode */

	return value;
}

Result ConstantExpression::GenerateCode()
{
	Result value;

	/*TODO: Implementar ConstantExpression::GenerateCode */
